...
public class StudentSubjectDAO implements Crud<StudentSubjectDTO> {
    ...
    public static final String TABLE_STUDENT_SUBJECT = "teacherStudentSubject";
    public static final String FIELD_ID_STUDENT_SUBJECT = "idStudentStudentSubject";
    public static final String FIELD_ID_STUDENT = "idStudent";
    public static final String FIELD_ID_SUBJECT = "idStudentSubject";
    public static final String CREATE_TABLE_STUDENT_SUBJECT =
            ...
            "FOREIGN KEY (" + FIELD_ID_STUDENT + ") REFERENCES teacher(idStudent), " +
            "FOREIGN KEY (" + FIELD_ID_SUBJECT + ") REFERENCES subject(idStudentSubject) " +
            ")";
